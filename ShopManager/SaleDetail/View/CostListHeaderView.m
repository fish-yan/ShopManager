...
@interface CostListHeaderView ()<UIWebViewDelegate> {
	UIView *view;
}
...
@implementation CostListHeaderView
...
- (UIView *)loadFromNib {
	UIView *xibView = [[[UINib nibWithNibName:@"CostListHeaderView" bundle:nil] instantiateWithOwner:self options:nil] firstObject];
	return xibView;
}
