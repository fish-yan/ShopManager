//
//  CardSaleAnalyseViewController.m
//  ShopManager
//
...
@interface CardSaleAnalyseViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation CardSaleAnalyseViewController
...
- (CardSaleAnalyseVM *)viewModel {
	if (_viewModel == nil) {
		_viewModel = [[CardSaleAnalyseVM alloc] init];
	}
	return _viewModel;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	CardSaleAnalyseItemVM *item = self.viewModel.listDataSource[indexPath.row];
	cell.nameL.text = item.cardName;
