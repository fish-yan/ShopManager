//
//  ProfitAnalyseDetailViewController.m
//  ShopManager
//
...
@interface ProfitAnalyseDetailViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation ProfitAnalyseDetailViewController
...
- (ProfitAnalyseDetailVM *)viewModel {
	if (_viewModel == nil) {
		_viewModel = [[ProfitAnalyseDetailVM alloc] init];
	}
	return _viewModel;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	ProfitAnalyseDetailItemVM *item = self.viewModel.listDataSource[indexPath.row];
